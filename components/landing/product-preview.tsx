...
export function ProductPreview() {
  return (
    <div
      aria-label="Momentum dashboard preview"
      ...
      <div className="rounded-2xl border border-[#dce0d9] bg-white p-3 shadow-[0_25px_70px_-28px_rgba(24,44,33,0.28)] sm:p-4">
        <div className="rounded-xl bg-[#f6f7f4] p-4 sm:p-5">
          <div className="flex items-center justify-between border-b border-[#e5e8e2] pb-4">
            <div>
              <p className="text-xs font-medium uppercase tracking-[0.14em] text-[#858a82]">
                Project overview
              </p>
              <p className="mt-1 font-semibold">Goodframe</p>
            </div>
            <span className="rounded-full bg-[#e3f2e8] px-3 py-1.5 text-xs font-medium text-[#377458]">
              Growing
            </span>
          </div>
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            <div className="rounded-xl bg-white p-4">
              ...
              <p className="mt-1 text-xs font-medium text-[#4b9470]">
                +18.4% this week
              </p>
            </div>
          ...
          <div className="mt-3 flex items-center gap-3 rounded-xl border border-[#e5e8e2] bg-white p-3">
            <span className="grid h-8 w-8 place-items-center rounded-full bg-[#f1f7f2] text-[#397958]">
              ↗
            </span>
            <p className="text-xs leading-5 text-[#626760]">
              Your latest update is resonating.{" "}
              <strong className="font-semibold text-[#343934]">
                62% opened it.
              </strong>
            </p>
          </div>
