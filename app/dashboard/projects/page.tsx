    ...
    <DashboardShell>
      <div className="mx-auto max-w-375">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="grid h-9 w-9 place-items-center rounded-lg text-[#858981] hover:bg-[#f0f2ee]"
                >
              ...
              {/* Action */}
              <button className="mt-5 flex w-full items-center justify-between rounded-xl border border-[#e2e6e0] px-4 py-3 text-sm font-medium text-[#303530] transition hover:border-[#b9cdbd] hover:bg-[#f8faf8]">
                Open project
          ...
          {/* Create card */}
          <button className="flex min-h-70 flex-col items-center justify-center rounded-2xl border border-dashed border-[#cbd8ce] bg-[#fbfcfa] p-6 text-center transition hover:border-[#8fb29b] hover:bg-[#f5f9f6]">
        ...
        <div className="mt-8 flex flex-col gap-3 rounded-2xl border border-[#dce8df] bg-[#eef6f0] p-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            <Users className="mt-0.5 shrink-0 text-[#337456]" size={19} />
